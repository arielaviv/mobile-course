...
class CommentRepository
    ...
    constructor(
        ...
        private fun collection(postId: String) = firestore.collection("distribution_points").document(postId).collection("comments")

        fun observeComments(postId: String): Flow<List<Comment>> = dao.observeByPostId(postId).map { entities -> entities.map { it.toDomain() } }
